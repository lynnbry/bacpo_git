...
\caption{Time series for the system $(\ref{l1})-(\ref{l4})$ illustrating convergence to the locally stable steady state $E_{1,2}^s$. Here the initial conditions are $s=0.45, e=0.2, t=0,x_1=0.3, x_2=0.05$. }
...
\end{subfigure}
\caption{Time series for system $(\ref{s1})-(\ref{s6})$ illustrating resistance to the invasion by cheaters (left, $k_3=0.99$) or Tragedy (right, $k_3=0.3$). The initial conditions for both simulations are $s=0.1, e=0.21,t=0, x_1= 0.6, x_2=0.02, x_3=0.03$.}
